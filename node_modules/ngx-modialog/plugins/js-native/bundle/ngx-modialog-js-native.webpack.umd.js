/** 
 * NgxModialogJsNative Copyright 2017
 * Licensed under MIT
 */
...
var Modal = (function (_super) {
    ...
    Modal.prototype.alert = function () {
        return new __WEBPACK_IMPORTED_MODULE_2__presets_js_native_preset__["a" /* JSNativePresetBuilder */](this, __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["DROP_IN_TYPE"].alert);
    };
    /**
     * @return {?}
     */
    Modal.prototype.prompt = function () {
        return new __WEBPACK_IMPORTED_MODULE_2__presets_js_native_preset__["a" /* JSNativePresetBuilder */](this, __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["DROP_IN_TYPE"].prompt);
    };
    /**
     * @return {?}
     */
    Modal.prototype.confirm = function () {
        return new __WEBPACK_IMPORTED_MODULE_2__presets_js_native_preset__["a" /* JSNativePresetBuilder */](this, __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["DROP_IN_TYPE"].confirm);
    };
    /**
     * @param {?} dialogRef
     * @param {?} type
    ...
    Modal.ctorParameters = function () { return [
        { type: __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["Overlay"], },
    ]; };
    return Modal;
}(__WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["Modal"]));
...
var JSNativeModalRenderer = (function () {
    ...
    JSNativeModalRenderer.prototype.render = function (dialog, vcRef) {
        ...
        switch (dialog.context.dialogType) {
            case __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["DROP_IN_TYPE"].alert:
                window.alert(dialog.context.message);
                result = true;
                break;
            case __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["DROP_IN_TYPE"].prompt:
                result = window.prompt(dialog.context.message, dialog.context.promptDefault);
                break;
            case __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["DROP_IN_TYPE"].confirm:
...
var JSNativeModalContext = (function (_super) {
    ...
    JSNativeModalContext.prototype.normalize = function () {
        ...
        if (this.dialogType === undefined)
            this.dialogType = __WEBPACK_IMPORTED_MODULE_0_ngx_modialog__["DROP_IN_TYPE"].alert;
    };
...
var JSNativeModalContextBuilder = (function (_super) {
    ...
    function JSNativeModalContextBuilder(defaultValues, initialSetters, baseType) {
        ...
        return _super.call(this, defaultValues || {}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_ngx_modialog__["arrayUnion"])(DEFAULT_SETTERS, initialSetters || []), baseType || JSNativeModalContext
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__js_native_module__ = __webpack_require__(7);
...
var /** @type {?} */ providers = [
    { provide: __WEBPACK_IMPORTED_MODULE_1_ngx_modialog__["Modal"], useClass: __WEBPACK_IMPORTED_MODULE_2__modal__["a" /* Modal */] },
...
//# sourceMappingURL=ngx-modialog-js-native.webpack.umd.js.map